...
class Config:
    ...
    BG_IMAGE_PATH: str = resource_path("assets/bg.png")
    POPUP_IMAGE_PATH: str = resource_path("assets/getlobstered.png")
    SOUNDFX_PATH: str = resource_path("assets/lobstersfx.wav")
